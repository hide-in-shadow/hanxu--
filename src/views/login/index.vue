  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="mobile">
        ...
        <el-input ref="mobile" v-model="loginForm.mobile" placeholder="请输入用户名" name="mobile" type="text" tabindex="1" auto-complete="on" />
      </el-form-item>
...
<script>
import { validmobile } from '@/utils/validate' // 引入校验规则
export default {
  name: 'Login',
  data() {
    ...
    return {
      ...
      loading: false, // 是否开始加载
      passwordType: 'password', // 控制密码是否可见
      redirect: undefined
    }
  },
  watch: {
